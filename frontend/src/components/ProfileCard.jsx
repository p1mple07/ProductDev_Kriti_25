    ...
    >
      <div className="bg-gray-900 rounded-lg shadow-xl overflow-hidden border border-green-500/20">
        ...
        <div className="relative h-40 overflow-hidden">
          <div
            className={`absolute inset-0 bg-gradient-to-r from-green-900 via-green-700 to-green-800 transition-transform duration-5000 ease-in-out ${isHovered ? "translate-x-full" : "translate-x-0"} animate-gradient`}
          />
          <div
            className={`absolute inset-0 bg-gradient-to-r from-green-800 via-green-700 to-green-900 transition-transform duration-5000 ease-in-out ${isHovered ? "translate-x-0" : "-translate-x-full"} animate-gradient`}
          />
        </div>
        ...
        <div className="relative px-8 pb-8">
          ...
          <div className="absolute -top-16 left-8 transform transition-transform duration-300 hover:scale-110">
            <div className="relative group">
              <img
                src={currentUser.profileImage || "https://media.istockphoto.com/id/1300845620/vector/user-icon-flat-isolated-on-white-background-user-symbol-vector-illustration.jpg?s=612x612&w=0&k=20&c=yBeyba0hUkh14_jgv1OKqIH0CCSWU_4ckRkAoy2p73o="}
                alt="User Profile"
              ...
              <div className="absolute inset-0 rounded-full bg-black bg-opacity-0 group-hover:bg-opacity-50 transition-all duration-300 flex items-center justify-center">
                <PencilIcon className="text-green-400 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
              </div>
            </div>
          </div>
          ...
          <div className="pt-20">
            <div className="flex items-center justify-between mb-4">
              ...
              <button className="mx-3 my-2 px-3 py-1 bg-green-600 text-white rounded-full text-xs font-medium hover:bg-green-500 transition-all duration-300 transform hover:-translate-y-1 hover:shadow-lg hover:shadow-green-500/30">
                <Link to="/profile" className="text-white hover:text-hover_accent">
                  Edit
                </Link>
              </button>
            </div>
